...
public class CrawlController extends Configurable {
    ...
    public CrawlController(CrawlConfig config, PageFetcher pageFetcher, RobotstxtServer robotstxtServer)
        ...
        if (!resumable) {
            frontier.clearData();
            logger.info("Deleted contents  ( as you have configured resumable crawling to false )");
        }
     ...
     * This method utilizes default crawler factory that creates new crawler
    ...
    /**
     * Once the crawling session finishes the controller collects the local data
     * of the crawler threads and stores them
     * in a List.
